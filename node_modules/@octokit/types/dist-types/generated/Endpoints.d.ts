...
declare type DataType<T> = "application/json" extends keyof T ? T["application/json"] : unknown;
declare type ExtractFirstSuccessResponse<R> = "responses" extends keyof R ? FirstSuccessResponse<R["responses"]> : unknown;
declare type FirstSuccessResponse<R, S extends keyof R = keyof R> = S extends keyof SuccessStatusesMap ? R[S] extends never ? Omit<OctokitResponse<unknown, SuccessStatusesMap[S]>, "data"> : OctokitResponse<DataType<R[S]>, SuccessStatusesMap[S]> : never;
